...
- Algorithm development in classical and quantum settings
- Scientific Foundations of Artificial Intelligence

### Journal publications
1. T Bourdais, A Gnanasekaran, H Owhadi, T Sahai, Discovering Algorithms with Computational Language Processing, In Press with Science Advances.
...
1. T. Sahai, A. Gnanasekaran, On the Emergence of Ergodic Dynamics in Unique Games, Working paper. [[arxiv link](https://arxiv.org/abs/2404.16024)]
...
3. J. Xing, D. Fischer, N. Labh, R. Piersma, B. C. Lee, Y. Xia, T. Sahai, V. Tarokh, Talaria: A Framework for Simulation of Permissioned Blockchains for Logistics and Beyond, Working Paper. [[arxiv link](https://arxiv.org/abs/2103.02260)]
...
5. T. Sahai, Stochastic Optimization using Polynomial Chaos Expansions, Working Paper. [[arxiv link](https://arxiv.org/abs/2009.08077)]
...
- H Gu, M Tyrrell, T Sahai, MA Katsoulakis, Sharp Stability Threshold and Certification for Designing Stable Residual Architectures, In Review, [[arxiv link](https://arxiv.org/pdf/2607.14576)]
- K Kan, X Li, BJ Zhang, T Sahai, S Osher, MA Katsoulakis, Dimension-Free Convergence of Discrete Diffusion Models: Adjoint Equations Induce the Right Space, In Review, [[arxiv link](https://arxiv.org/pdf/2605.17232)]
- Z. Zhang, H. Gu, B. J. Zhang, D. Elenius, M. Tyrrell, T. J. Bourdais, H. Owhadi, M. A Katsoulakis, T. Sahai, ISOMORPH: A Supply Chain Digital Twin for Simulation, Dataset Generation, and Forecasting Benchmarks, In Review, [[arxiv link](https://arxiv.org/pdf/2605.12768)]
...
- N Schwartz, CK Nagesh, S Sankaranarayanan, R Kaur, T Sahai, S Jha, Optimized Piecewise Affine Abstractions of Neural
Networks with Learnable Activation Function, Formal Methods in Computer-Aided Design Formal Methods in Computer-Aided Design 2026 [[arxiv link](https://arxiv.org/pdf/2602.06737)]
- C K. Nagesh, S Sankaranarayanan, R Kaur, T Sahai, S Jha, Taylor-Model Physics-Informed Neural Networks (PINNs) for Ordinary Differential Equations, In Review
- K Kan, X Li, BJ Zhang, T Sahai, S Osher, MA Katsoulakis, Optimal Control for Transformer Architectures: Enhancing Generalization, Robustness and Efficiency, Neurips 2025 (Main Track Poster).[[Conference link](https://neurips.cc/virtual/2025/loc/san-diego/poster/118764)] [[arxiv link](https://arxiv.org/pdf/2505.13499?)]
...
### Patents
- Automated discovery of alternate manufacturing pathways, 19222136, Filed December 2024
